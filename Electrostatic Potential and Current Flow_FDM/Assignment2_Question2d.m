...
% subplot(1,2,1)
surf(eFlowx', eFlowy','Edgecolor','c');
axis([0 L 0 W]);
title({'Change in Current Density vs change in conductivity';'{\itConductivity value} = 0.01'})
...
% axis([0 L 0 W]);
% title({'Change in Current Density vs change in conductivity';'{\itConductivity value} = 0.001'})
% xlabel('Length of region')
% ylabel('Width of region')
